...
This package has also included all commands to integrate somatic SV calls and discover prostate cancer related subgroups and SV hotspots, described in the following publication:
